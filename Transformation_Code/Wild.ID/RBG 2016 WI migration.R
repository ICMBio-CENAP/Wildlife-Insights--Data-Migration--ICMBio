...
setwd("C:/Users/ICMBio/R")

source('wi_functions.R')

# Load Wild.ID export
images <- read_excel("C:/Users/ICMBio/R/Wild_ID_RBG_1/Wild_ID_RBG.xlsx",sheet="Image")
deployments <- read_excel("C:/Users/ICMBio/R/Wild_ID_RBG_1/Wild_ID_RBG.xlsx",sheet="Deployment")
cameras <- read_excel("C:/Users/ICMBio/R/Wild_ID_RBG_1/Wild_ID_RBG.xlsx",sheet="Cameras")
projects <- read_excel("C:/Users/ICMBio/R/Wild_ID_RBG_1/Wild_ID_RBG.xlsx",sheet="Project")
####
...
prj_bu$project_admin_organization <- "CENAP" #projects$`Project Owner (Organization or Individual)`
...
#your_taxa <- read.csv("WI_raw_exports/taxonomic_mapping_template_ALM.csv",colClasses = "character",strip.white = TRUE,na.strings="")
  # modified Elildo version of previous line (useless because this file is for Peru site):
  #your_taxa <- read.csv("taxonomic_mapping_template_ALM_ELILDO.csv")
  # so instead Elildo create clean taxonomy with WI_taxonomy.R:
  load("WI_Taxonomy.R")
