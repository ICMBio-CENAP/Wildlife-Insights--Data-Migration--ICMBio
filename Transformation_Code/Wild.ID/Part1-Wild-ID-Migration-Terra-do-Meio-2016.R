...
# set wd
#setwd("C:/Users/ICMBio/R/Terra do Meio")
...
#dir_path <- "C:/Users/ICMBio/R/Terra do Meio/"
...
# fix image names that have no unique identifier (needed for the taxonomy mapping)
  ...
  images$`Genus Species` <- factor(images$`Genus Species`)
  levels(images$`Genus Species`)[levels(images$`Genus Species`)=="Campephilus unknown"] <- "Campephilus"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Campephilus unknown"] <- "Campephilus"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Cathartes unknown"] <- "Cathartes"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Chamaeza unknown"] <- "Chamaeza"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Crypturellus unknown"] <- "Crypturellus"
  images<- images[!(images$`Genus Species`=="Dasycercus unknown"),]
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Dactylomys unknown"] <- "Dactylomys"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Dasyprocta unknown"] <- "Dasyprocta ruatanica"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Dasypus unknown"] <- "Dasypus"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Geotrygon unknown"] <- "Geotrygon"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Formicarius unknown"] <- "Formicarius"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Leopardus unknown"] <- "Leopardus"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Leptotila unknown"] <- "Leptotila"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Mazama unknown"] <- "Mazama"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Mitu tomentosum"] <- "Mitu tuberosum"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Mitu unknown"] <- "Mitu tuberosum"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Monasa unknown"] <- "Monasa"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Myrmoborus unknown"] <- "Myrmoborus" 
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Neopmorphus unknown"] <- "Neopmorphus" 
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Pauxi unknown"] <- "Mitu tuberosum"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Penelope unknown"] <- "Penelope"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Proechimys unknown"] <- "Proechimys"
  images<- images[!(images$`Genus Species`=="Proedromys unknown"),]
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Psophia unknown"] <- "Psophia viridis"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Puma unknown"] <- "Puma"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Rhegmatorhina unknown"] <- "Rhegmatorhina"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Saimiri unknown"] <- "Saimiri"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Cebus apella"] <- "Sapajus apella"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Sciurus unknown"] <- "Sciurus aestuans"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Tigrisoma unknown"] <- "Tigrisoma"
  levels(images$`Genus Species`)[levels(images$`Genus Species`)== "Tinamus unknown"] <- "Tinamus"
  images$`Genus Species` <- as.character(images$`Genus Species`)
...
images_taxa$new_location <- gsub("\\\\","/",images_taxa$Location)
  ...
  images_taxa$wi_path <- paste("gs://icmbio/Terra do Meio","/",images_taxa$new_location,sep="")

# If all images were identified by one person, set this here. Otherwise comment this out.
#image_identified_by <- "E. Carvalho Jr, A. Martins, E.N. Mendon?a"
