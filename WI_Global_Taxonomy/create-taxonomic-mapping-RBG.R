...
levels(original_gs)[levels(original_gs)=="Psophia unknown"] <- "Psophia obscura"
levels(original_gs)[levels(original_gs)=="Psophia viridis"] <- "Psophia obscura"
levels(original_gs)[levels(original_gs)=="Dasypus sp"] <- "Dasypus unknown"
levels(original_gs)[levels(original_gs)=="Crypturellus sp"] <- "Crypturellus unknown"
