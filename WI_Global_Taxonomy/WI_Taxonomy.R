...
wi_taxa_data <- read.csv(here("WI_Global_Taxonomy", "WI_Global_Taxonomy.csv"))
...
#write.csv(wi_taxa_data, here("WI_Global_Taxonomy", "WI_Global_Taxonomy.csv"), row.names = FALSE)
