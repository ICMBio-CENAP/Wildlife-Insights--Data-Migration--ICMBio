...
Code to get camera-trap data from ICMBio/CENAP into the format required to be uploaded into Wildlife Insights

This repository has customized scripts and functions that work for ICMBio datasets, but most of it has been adapted from the original repository [Wildlife-Insights----Data-Migration](https://github.com/ConservationInternational/Wildlife-Insights----Data-Migration) from Conservation International
